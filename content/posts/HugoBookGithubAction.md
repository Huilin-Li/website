+++
title = "In Windows10, build personal website via Hugo-book and Github Actions"
description = "In Windows10, Use Hugo to create the local website, and deploy it to GitHub via Github Action."
tags = [
    "hugo-book",
    "Github Actions",
    "windows10"
